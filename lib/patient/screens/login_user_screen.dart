              ...
              child: SingleChildScrollView(
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      20.hs,
                      Image.asset(AppImages.loginIcon, height: 180, width: 180),
                      20.hs,
                      Obx(
                        () => EditTextField(
                          ...
                          errorText: loginController.isPhoneNumberError.value
                              ...
                              : null,
                          onChanged: (val) {
                            loginController.phoneNumber.value = val.trim();
                      ...
                      Obx(
                        () => EditTextField(
                          ...
                          errorText: loginController.isPasswordError.value
                              ...
                              : null,
                          onChanged: (val) {
                            loginController.pass.value = val.trim();
